...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Inside Global Events" },
      { name: "description", content: "Inside Global Events (IGE) is a vertically integrated event intelligence and sponsorship marketplace for the Africa-Europe corridor and the global events economy." },
      { name: "author", content: "Inside Global Events" },
      { property: "og:title", content: "Inside Global Events" },
      { property: "og:description", content: "Inside Global Events (IGE) is a vertically integrated event intelligence and sponsorship marketplace for the Africa-Europe corridor and the global events economy." },
      { property: "og:type", content: "website" },
      { property: "og:site_name", content: "Inside Global Events" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "Inside Global Events" },
      { name: "twitter:description", content: "Inside Global Events (IGE) is a vertically integrated event intelligence and sponsorship marketplace for the Africa-Europe corridor and the global events economy." },
