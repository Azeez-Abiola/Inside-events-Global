...
import { b as Route$B, u as useAuth, n as useServerFn, i as getPublicEventBySlug, f as getCurrentRates, d as SiteHeader, S as SiteFooter, s as submitCommitmentForm, t as toggleSaveEvent } from "./router-CyTgVp-T.mjs";
import { a as useQuery, u as useMutation, b as useQueryClient } from "../_libs/tanstack__react-query.mjs";
...
import { C as CoverageRequestModal } from "./media-dashboard-B1JUzCsE.mjs";
import "../_libs/seroval.mjs";
import "../_libs/ws.mjs";
import { k as ChevronLeft, a2 as ShieldCheck, C as Calendar, P as MapPin, ad as Users, G as Globe, m as CircleCheck, W as Pencil, V as Newspaper, a4 as Sparkles, s as Download, f as CalendarPlus, l as CircleAlert, c as Bookmark, d as BookmarkCheck } from "../_libs/lucide-react.mjs";
...
function EventDetail() {
  ...
  const [showMediaRequest, setShowMediaRequest] = reactExports.useState(false);
  const [selectedTier, setSelectedTier] = reactExports.useState(null);
  if (isLoading) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(EventPageLayout, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "py-24 text-center text-muted-foreground", children: "Loading event…" }) });
  }
  const event = data?.event;
  if (!event) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(EventPageLayout, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "py-24 text-center", children: [
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(EventPageLayout, { children: [
    user && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: isAdmin ? "/dashboard/vetting" : "/dashboard", className: "inline-flex items-center gap-1.5 text-sm font-medium text-muted-foreground hover:text-foreground", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronLeft, { className: "h-4 w-4" }),
      "Back"
    ] }) }),
    event.banner_image_url && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative -mx-6 mb-8 h-72 overflow-hidden bg-muted md:rounded-xl", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: event.banner_image_url, alt: event.name, className: "h-full w-full object-cover" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-10 lg:grid-cols-[2fr_1fr]", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "mt-10", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4 grid gap-4 md:grid-cols-2", children: [
            (data?.tiers ?? []).map((t) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `rounded-xl border p-5 transition-colors ${selectedTier === t.id ? "border-primary bg-primary/5" : "border-border bg-card"}`, children: [
              ...
              canEngageAsSponsor && /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", onClick: () => {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(GetInvolvedAside, { event, refCode: search.ref ?? null, isAdmin, isOwner, isMediaPartner, canEngageAsSponsor, onSponsor: () => {
        setSelectedTier(null);
        setShowSponsor(true);
      }, onCommitment: () => setShowForm(true), onMediaRequest: () => setShowMediaRequest(true) })
    ] }),
    showSponsor && /* @__PURE__ */ jsxRuntimeExports.jsx(SponsorInterestDialog, { eventId: event.id, eventName: event.name, tiers: data?.tiers ?? [], onClose: () => setShowSponsor(false) }),
    ...
    showMediaRequest && /* @__PURE__ */ jsxRuntimeExports.jsx(CoverageRequestModal, { event: {
      id: event.id,
      name: event.name
...
function GetInvolvedAside({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("aside", { className: "space-y-4", children: [
    isOwner && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border border-primary/30 bg-brand-soft/30 p-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-semibold uppercase tracking-wide text-primary-deep", children: "Your event" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-sm text-muted-foreground", children: "Manage this listing from your organiser workspace." }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4 space-y-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/events/edit/$id", params: {
          id: event.id
        }, className: `${actionBtn} border-primary/40 bg-card`, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Pencil, { className: "h-4 w-4" }),
          " Edit event"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/dashboard/pipeline", className: actionBtn, children: "View pipeline & analytics" })
      ] })
    ] }),
    isAdmin && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border border-border bg-card p-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-semibold uppercase tracking-wide text-muted-foreground", children: "Admin" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-sm text-muted-foreground", children: "Review vetting details or open the full editor." }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4 space-y-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/dashboard/vetting", className: actionBtn, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(ShieldCheck, { className: "h-4 w-4" }),
          " Open vetting queue"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/events/edit/$id", params: {
          id: event.id
        }, className: actionBtn, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Pencil, { className: "h-4 w-4" }),
          " Event editor"
        ] })
      ] })
    ] }),
    isMediaPartner && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border border-border bg-card p-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-semibold uppercase tracking-wide text-muted-foreground", children: "Media partner" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-sm text-muted-foreground", children: "Save this event or request coverage / press credentials." }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4 space-y-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(SaveEventButton, { eventId: event.id }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { type: "button", onClick: onMediaRequest, className: `${actionBtn} border-primary/30`, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Newspaper, { className: "h-4 w-4" }),
          " Request coverage"
        ] })
      ] })
    ] }),
    canEngageAsSponsor && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border border-border bg-card p-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs uppercase tracking-wide text-muted-foreground", children: "Get involved" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { type: "button", onClick: onSponsor, className: "mt-3 inline-flex w-full items-center justify-center gap-1.5 rounded-md bg-brand-gradient px-4 py-2.5 text-sm font-semibold text-white shadow-soft hover:-translate-y-0.5 transition-transform", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { className: "h-4 w-4" }),
        " Sponsor this event"
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", onClick: onCommitment, className: `mt-2 ${actionBtn}`, children: "Submit a Commitment Form" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(SaveEventButton, { eventId: event.id }),
      ...
      refCode && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-3 rounded-md bg-secondary/10 px-3 py-2 text-xs text-secondary-deep", children: [
        "Attributed to partner: ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono", children: refCode })
      ] })
    ] }),
    event.sponsorship_deck_url && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border border-border bg-card p-6", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: event.sponsorship_deck_url, target: "_blank", rel: "noopener noreferrer", download: true, className: `mt-3 ${actionBtn}`, children: [
    ...
    event.cal_booking_url && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border border-border bg-card p-6", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: event.cal_booking_url, target: "_blank", rel: "noopener noreferrer", className: `mt-3 ${actionBtn}`, children: [
...
function CommitmentDialog({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 z-50 flex items-center justify-center bg-black/60 p-4", onClick: onClose, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-h-[90vh] w-full max-w-2xl overflow-y-auto rounded-xl bg-card shadow-2xl", onClick: (e) => e.stopPropagation(), children: submitted ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-10 text-center", children: [
...
function SponsorInterestDialog({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 z-50 flex items-center justify-center bg-black/60 p-4", onClick: onClose, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-h-[90vh] w-full max-w-lg overflow-y-auto rounded-xl bg-card shadow-2xl", onClick: (e) => e.stopPropagation(), children: mutation.isSuccess ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-10 text-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "mx-auto h-12 w-12 text-secondary" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-4 md:grid-cols-2", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Tier of interest", children: tiers.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("select", { value: form.tier_interest, onChange: (e) => setForm({
        ...form,
        tier_interest: e.target.value
      }), className: FORM_INPUT, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "", children: "Select a tier…" }),
        tiers.map((t) => /* @__PURE__ */ jsxRuntimeExports.jsxs("option", { value: t.tier_name, children: [
          t.tier_name,
          " — ",
          t.currency,
          " ",
      ...
      ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "rounded-md border border-dashed border-border bg-muted/30 px-3 py-2.5 text-sm text-muted-foreground", children: "No sponsorship tiers published yet." }) })
    ] }),
