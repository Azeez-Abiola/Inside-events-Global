...
import { d as createServerFn, T as TSS_SERVER_FUNCTION, u as getServerFnById } from "./server-Dl4ga8RB.mjs";
...
import { a4 as Sparkles, a as ArrowRight, a2 as ShieldCheck, E as Earth, H as Handshake, C as Calendar, O as MapPin, ac as Users, P as Megaphone, m as CircleCheck, a7 as TrendingUp } from "../_libs/lucide-react.mjs";
...
const appCss = "/assets/styles-C4uS-FFk.css";
...
const $$splitComponentImporter$z = () => import("./welcome-CUPjJiS2.mjs");
const Route$M = createFileRoute("/welcome")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$y = () => import("./waitlist-D9WV6sr9.mjs");
const Route$L = createFileRoute("/waitlist")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$x = () => import("./unsubscribe-Dh6qPpoi.mjs");
const Route$K = createFileRoute("/unsubscribe")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$w = () => import("./trust-vetting-tTu8Zr1B.mjs");
const Route$J = createFileRoute("/trust-vetting")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$v = () => import("./terms-Cl411bw3.mjs");
...
const $$splitComponentImporter$u = () => import("./sponsors-CYYbbqJm.mjs");
const Route$H = createFileRoute("/sponsors")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$t = () => import("./signup-DT6rEPXx.mjs");
...
const $$splitComponentImporter$s = () => import("./reset-password-CGR6GrL1.mjs");
...
const $$splitComponentImporter$r = () => import("./privacy-D6fMcPVY.mjs");
...
const $$splitComponentImporter$q = () => import("./pricing-D8bm-ISi.mjs");
...
const $$splitComponentImporter$p = () => import("./partners-mEEtXHYX.mjs");
const Route$B = createFileRoute("/partners")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$o = () => import("./organisers-BzmPMEhH.mjs");
const Route$A = createFileRoute("/organisers")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$n = () => import("./onboarding-DIQPuGPy.mjs");
...
const $$splitComponentImporter$m = () => import("./marketplace-DN3e32Ry.mjs");
const Route$y = createFileRoute("/marketplace")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$l = () => import("./login-BeIRUyhc.mjs");
...
const $$splitComponentImporter$k = () => import("./how-it-works-C1g1zI5u.mjs");
const Route$w = createFileRoute("/how-it-works")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$j = () => import("./forgot-password-BoKDjF1k.mjs");
const Route$v = createFileRoute("/forgot-password")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$i = () => import("./faq-C6ePTUMp.mjs");
...
const $$splitComponentImporter$h = () => import("./contact-Cl2R2QL5.mjs");
...
const $$splitComponentImporter$g = () => import("./about-mzE2qNo_.mjs");
...
const $$splitComponentImporter$f = () => import("../_authenticated-BFsOu0JM.mjs");
...
const $$splitComponentImporter$e = () => import("./r._code-BTU5dmpx.mjs");
const Route$p = createFileRoute("/r/$code")({
  beforeLoad: async ({
    params
  }) => {
    try {
...
const $$splitComponentImporter$d = () => import("./onboarding.profile-bikPPDUG.mjs");
const Route$o = createFileRoute("/onboarding/profile")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$c = () => import("./events._slug-zyp2zLUA.mjs");
const searchSchema$1 = objectType({
  ref: stringType().max(20).optional()
});
const Route$n = createFileRoute("/events/$slug")({
...
const Route$m = createFileRoute("/email/unsubscribe")({
  server: {
    handlers: {
      GET: async ({ request }) => {
...
const $$splitComponentImporter$b = () => import("./settings-CwBmzpqN.mjs");
...
const $$splitComponentImporter$a = () => import("./referrals-DPZDxXa4.mjs");
const Route$k = createFileRoute("/_authenticated/referrals")({
  head: () => ({
    meta: [{
      title: "Referrals - IGE"
    }]
...
const $$splitComponentImporter$9 = () => import("./pipeline-DmmtLWG3.mjs");
const Route$j = createFileRoute("/_authenticated/pipeline")({
  head: () => ({
    meta: [{
      title: "Pipeline - IGE"
    }]
...
const $$splitComponentImporter$8 = () => import("./messages-PFoO1_03.mjs");
const searchSchema = objectType({
  thread: stringType().uuid().optional()
});
const Route$i = createFileRoute("/_authenticated/messages")({
...
const $$splitComponentImporter$7 = () => import("./events-BFsOu0JM.mjs");
const Route$h = createFileRoute("/_authenticated/events")({
  component: lazyRouteComponent($$splitComponentImporter$7, "component")
});
const $$splitComponentImporter$6 = () => import("./deals-CyK3vQu0.mjs");
const Route$g = createFileRoute("/_authenticated/deals")({
  head: () => ({
    meta: [{
      title: "My deals - IGE"
    }]
...
const $$splitComponentImporter$5 = () => import("./dashboard-C6qgvHdd.mjs");
...
const $$splitComponentImporter$4 = () => import("./events.index-UxHg4p-G.mjs");
const Route$e = createFileRoute("/_authenticated/events/")({
  head: () => ({
    meta: [{
      title: "My events - IGE"
    }]
...
const Route$d = createFileRoute("/lovable/email/suppression")({
  server: {
    handlers: {
      POST: async ({ request }) => {
...
const Route$c = createFileRoute("/api/public/waitlist-notify")({
  server: {
    handlers: {
      POST: async ({ request }) => {
        let body2;
...
const Route$b = createFileRoute("/api/public/contact")({
  server: {
    handlers: {
      POST: async ({ request }) => {
        let body2;
...
const $$splitComponentImporter$3 = () => import("./admin.vetting-CPWpnGQg.mjs");
const Route$a = createFileRoute("/_authenticated/admin/vetting")({
  head: () => ({
    meta: [{
      title: "Vetting queue - IGE Admin"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./admin.submissions-BSsRosgv.mjs");
...
const $$splitComponentImporter$1 = () => import("./admin.revenue-CzWUrPuV.mjs");
const Route$8 = createFileRoute("/_authenticated/admin/revenue")({
  head: () => ({
    meta: [{
      title: "Revenue - IGE Admin"
    }]
  }),
...
const $$splitComponentImporter = () => import("./events.edit._id-Czy6qsM7.mjs");
...
const WelcomeRoute = Route$M.update({
  id: "/welcome",
  path: "/welcome",
  getParentRoute: () => Route$N
});
const WaitlistRoute = Route$L.update({
  id: "/waitlist",
  path: "/waitlist",
  getParentRoute: () => Route$N
});
const UnsubscribeRoute = Route$K.update({
  id: "/unsubscribe",
  path: "/unsubscribe",
  getParentRoute: () => Route$N
});
const TrustVettingRoute = Route$J.update({
  id: "/trust-vetting",
  path: "/trust-vetting",
  getParentRoute: () => Route$N
});
...
const SponsorsRoute = Route$H.update({
  id: "/sponsors",
  path: "/sponsors",
  getParentRoute: () => Route$N
});
...
const PartnersRoute = Route$B.update({
  id: "/partners",
  path: "/partners",
  getParentRoute: () => Route$N
});
const OrganisersRoute = Route$A.update({
  id: "/organisers",
  path: "/organisers",
  getParentRoute: () => Route$N
});
...
const MarketplaceRoute = Route$y.update({
  id: "/marketplace",
  path: "/marketplace",
  getParentRoute: () => Route$N
});
...
const HowItWorksRoute = Route$w.update({
  id: "/how-it-works",
  path: "/how-it-works",
  getParentRoute: () => Route$N
});
const ForgotPasswordRoute = Route$v.update({
  id: "/forgot-password",
...
const RCodeRoute = Route$p.update({
  id: "/r/$code",
  path: "/r/$code",
  getParentRoute: () => Route$N
});
const OnboardingProfileRoute = Route$o.update({
  id: "/profile",
  path: "/profile",
  getParentRoute: () => OnboardingRoute
});
const EventsSlugRoute = Route$n.update({
  id: "/events/$slug",
  path: "/events/$slug",
  getParentRoute: () => Route$N
});
const EmailUnsubscribeRoute = Route$m.update({
...
const AuthenticatedReferralsRoute = Route$k.update({
  id: "/referrals",
  path: "/referrals",
  getParentRoute: () => AuthenticatedRoute
});
const AuthenticatedPipelineRoute = Route$j.update({
  id: "/pipeline",
  path: "/pipeline",
  getParentRoute: () => AuthenticatedRoute
});
const AuthenticatedMessagesRoute = Route$i.update({
  id: "/messages",
  path: "/messages",
  getParentRoute: () => AuthenticatedRoute
});
const AuthenticatedEventsRoute = Route$h.update({
  id: "/events",
  path: "/events",
  getParentRoute: () => AuthenticatedRoute
});
const AuthenticatedDealsRoute = Route$g.update({
  id: "/deals",
  path: "/deals",
  getParentRoute: () => AuthenticatedRoute
});
...
const AuthenticatedEventsIndexRoute = Route$e.update({
  id: "/",
  path: "/",
  getParentRoute: () => AuthenticatedEventsRoute
});
const LovableEmailSuppressionRoute = Route$d.update({
  id: "/lovable/email/suppression",
  path: "/lovable/email/suppression",
  getParentRoute: () => Route$N
});
const ApiPublicWaitlistNotifyRoute = Route$c.update({
  id: "/api/public/waitlist-notify",
  path: "/api/public/waitlist-notify",
  getParentRoute: () => Route$N
});
const ApiPublicContactRoute = Route$b.update({
