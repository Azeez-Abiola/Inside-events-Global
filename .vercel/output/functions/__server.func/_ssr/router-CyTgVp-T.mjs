...
import { d as createServerFn, T as TSS_SERVER_FUNCTION, u as getServerFnById } from "./server-DRh9RfeA.mjs";
...
import { T as TEMPLATES, n as normalizeAuthRedirectUrl, s as sendTransactionalEmailServer } from "./site-url-Du7GW4Cs.mjs";
...
import { o as objectType, s as stringType, l as literalType, e as enumType, n as numberType, c as booleanType, b as arrayType } from "../_libs/zod.mjs";
...
const appCss = "/assets/styles-WIPbbHWu.css";
...
function AuthProvider({ children }) {
  ...
  const signOut = async () => {
    ...
    await router2.navigate({ to: "/login" });
  };
...
const Route$10 = createRootRouteWithContext()({
  head: () => ({
    meta: [
      { charSet: "utf-8" },
...
const $$splitComponentImporter$J = () => import("./welcome-B6McfdxC.mjs");
const Route$$ = createFileRoute("/welcome")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$I = () => import("./waitlist-Bpo7OG-_.mjs");
const Route$_ = createFileRoute("/waitlist")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$H = () => import("./unsubscribe-CEBdS6SF.mjs");
...
const $$splitComponentImporter$G = () => import("./trust-vetting-DTsEaj2Y.mjs");
const Route$Y = createFileRoute("/trust-vetting")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$F = () => import("./terms-Cl411bw3.mjs");
...
const $$splitComponentImporter$E = () => import("./sponsors-XGfON_Rr.mjs");
const Route$W = createFileRoute("/sponsors")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$D = () => import("./signup-xoyJxWfz.mjs");
const signupSearch = objectType({
  step: enumType(["role", "account", "profile"]).optional()
});
const Route$U = createFileRoute("/signup")({
...
const $$splitComponentImporter$C = () => import("./reset-password-DygqXA2C.mjs");
...
const $$splitComponentImporter$B = () => import("./privacy-D6fMcPVY.mjs");
const Route$S = createFileRoute("/privacy")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$A = () => import("./pricing-Eh4M2AG-.mjs");
const Route$R = createFileRoute("/pricing")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$z = () => import("./partners-DZ9k9YHi.mjs");
const Route$Q = createFileRoute("/partners")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$y = () => import("./organisers-CDgcU-75.mjs");
const Route$P = createFileRoute("/organisers")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$x = () => import("./onboarding--4zTDHFL.mjs");
...
const $$splitComponentImporter$w = () => import("./marketplace-DWU46GZc.mjs");
...
const $$splitComponentImporter$v = () => import("./login-BMZV_MIC.mjs");
const search = objectType({
  redirect: stringType().optional(),
  email: stringType().max(200).optional(),
...
const $$splitComponentImporter$u = () => import("./knowledge-base-BlBbPnNN.mjs");
const Route$L = createFileRoute("/knowledge-base")({
  head: () => ({
    meta: [{
      title: "IGE Knowledge Base — Dashboard Walkthroughs & Demo Accounts"
    }, {
      name: "description",
      content: "Explore every IGE workspace: organiser, sponsor, referral partner, media, and admin dashboards. Demo login credentials, feature walkthroughs, and platform guides."
    }, {
      property: "og:title",
      content: "IGE Knowledge Base — Platform Guide"
    }, {
      property: "og:url",
      content: "https://www.insideglobalevents.com/knowledge-base"
    }],
    links: [{
      rel: "canonical",
      href: "https://www.insideglobalevents.com/knowledge-base"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$u, "component")
});
const $$splitComponentImporter$t = () => import("./how-it-works-I_YJLjQr.mjs");
...
const $$splitComponentImporter$s = () => import("./forgot-password-Bpmu4ZI6.mjs");
...
const $$splitComponentImporter$r = () => import("./faq-BPzixjgi.mjs");
...
const $$splitComponentImporter$q = () => import("./contact-DbgM89QE.mjs");
...
const $$splitComponentImporter$p = () => import("./about-CQv1i5Hg.mjs");
...
function SiteHeader() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "sticky top-0 z-50 border-b border-border/60 bg-background/80 backdrop-blur-md", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto flex h-16 max-w-7xl items-center justify-between px-6", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "hidden items-center gap-8 text-sm font-medium text-muted-foreground md:flex", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/knowledge-base", className: "transition-colors hover:text-foreground", children: "Knowledge base" })
    ] }),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "border-t border-border/60 bg-muted/30", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto grid max-w-7xl gap-10 px-6 py-14 md:grid-cols-4", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "mt-4 space-y-2 text-sm text-muted-foreground", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/knowledge-base", className: "hover:text-foreground", children: "Knowledge base" }) }),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background text-foreground", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        ClientOnly,
        {
          fallback: /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "border-t border-border/60 bg-muted/20 py-20", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-auto max-w-7xl px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3", children: Array.from({ length: 3 }).map((_, i) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-72 animate-pulse rounded-xl bg-muted" }, i)) }) }) }),
          children: /* @__PURE__ */ jsxRuntimeExports.jsx(MarketplacePreview, {})
        }
      ),
...
const $$splitComponentImporter$m = () => import("./onboarding.profile-bXsRa0Ur.mjs");
const Route$C = createFileRoute("/onboarding/profile")({
  component: lazyRouteComponent($$splitComponentImporter$m, "component")
});
const $$splitComponentImporter$l = () => import("./events._slug-B2u-iS3z.mjs");
...
const $$splitComponentImporter$k = () => import("./settings-0bMhixBj.mjs");
...
const $$splitComponentImporter$j = () => import("./messages-SywMoZiN.mjs");
...
const $$splitComponentImporter$h = () => import("./deals-DNoRdcwj.mjs");
...
const $$splitComponentImporter$f = () => import("./events.index-DgdlTbmz.mjs");
...
const $$splitComponentImporter$e = () => import("./dashboard.index-ClYJINF1.mjs");
...
const $$splitComponentImporter$d = () => import("./dashboard.vetting-DmYKzd4i.mjs");
...
const $$splitComponentImporter$c = () => import("./dashboard.submissions-C2Ex5FoX.mjs");
...
const $$splitComponentImporter$b = () => import("./dashboard.saved-BkvBSd-h.mjs");
...
const $$splitComponentImporter$a = () => import("./dashboard.revenue-CZZKU5YS.mjs");
...
const $$splitComponentImporter$9 = () => import("./dashboard.requests-DS6JxlQM.mjs");
...
const $$splitComponentImporter$8 = () => import("./dashboard.referrals-Bf_-XMyX.mjs");
...
const $$splitComponentImporter$7 = () => import("./dashboard.pipeline-CPktyA3o.mjs");
...
const $$splitComponentImporter$6 = () => import("./dashboard.explore-emjisirI.mjs");
...
const $$splitComponentImporter$5 = () => import("./dashboard.discover-DidCvaXH.mjs");
...
const $$splitComponentImporter$4 = () => import("./dashboard.deals-BewLaGGk.mjs");
...
const $$splitComponentImporter$3 = () => import("./dashboard.controls-ChXJYZU_.mjs");
...
const $$splitComponentImporter$2 = () => import("./dashboard.commitments-Bvwmip_4.mjs");
...
const $$splitComponentImporter$1 = () => import("./dashboard.analytics-CaSMQoTa.mjs");
  ...
  /* @__PURE__ */ jsxRuntimeExports.jsx(Body, { style: main$5, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Container, { style: container$5, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Section, { style: hero, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Text, { style: lead, children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: siteName }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Section, { style: card, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { style: button$4, href: confirmationUrl, children: "Verify email & continue" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Text, { style: footer$5, children: [
      "If you didn't create an account on",
      " ",
      /* @__PURE__ */ jsxRuntimeExports.jsx(Link$1, { href: siteUrl, style: link$2, children: siteUrl.replace(/^https?:\/\//, "") }),
      ", you can safely ignore this email."
    ] })
  ] }) })
] });
const main$5 = { backgroundColor: "#f4f0fa", fontFamily: "Inter, Arial, sans-serif" };
const container$5 = { margin: "0 auto", padding: "24px 16px", maxWidth: "560px" };
const hero = {
...
const h1$5 = { margin: "0 0 12px", fontSize: "24px", fontWeight: 700, color: "#ffffff" };
...
const text$5 = { fontSize: "14px", color: "#3f3f46", lineHeight: "1.6", margin: "0 0 20px" };
const link$2 = { color: "#5b2d8e", textDecoration: "underline" };
const button$4 = {
...
const footer$5 = { fontSize: "12px", color: "#a1a1aa", margin: "24px 0 0", lineHeight: 1.5 };
const InviteEmail = ({
  siteName,
  siteUrl,
  confirmationUrl
...
const SAMPLE_PROJECT_URL = "https://www.insideglobalevents.com";
...
const $$splitComponentImporter = () => import("./events.edit._id-_Aa3MLqJ.mjs");
...
const WelcomeRoute = Route$$.update({
  id: "/welcome",
  path: "/welcome",
  getParentRoute: () => Route$10
});
const WaitlistRoute = Route$_.update({
  id: "/waitlist",
  path: "/waitlist",
  getParentRoute: () => Route$10
});
...
const TrustVettingRoute = Route$Y.update({
  id: "/trust-vetting",
  path: "/trust-vetting",
  getParentRoute: () => Route$10
});
...
const SponsorsRoute = Route$W.update({
  id: "/sponsors",
  path: "/sponsors",
  getParentRoute: () => Route$10
});
...
const SignupRoute = Route$U.update({
  id: "/signup",
  path: "/signup",
  getParentRoute: () => Route$10
});
...
const PrivacyRoute = Route$S.update({
  id: "/privacy",
  path: "/privacy",
  getParentRoute: () => Route$10
});
const PricingRoute = Route$R.update({
  id: "/pricing",
  path: "/pricing",
  getParentRoute: () => Route$10
});
const PartnersRoute = Route$Q.update({
  id: "/partners",
  path: "/partners",
  getParentRoute: () => Route$10
});
const OrganisersRoute = Route$P.update({
  id: "/organisers",
  path: "/organisers",
  getParentRoute: () => Route$10
});
...
const KnowledgeBaseRoute = Route$L.update({
  id: "/knowledge-base",
  path: "/knowledge-base",
  getParentRoute: () => Route$10
});
...
export {
  ...
  SiteHeader as d,
  createSsrRpc as e,
  getCurrentRates as f,
  generateReferralLink as g,
  getMarketplaceFilterOptions as h,
  getPublicEventBySlug as i,
  getReferralDashboard as j,
  logo as k,
  listMarketplaceEvents as l,
  useScrollReveal as m,
  useServerFn as n,
  router as r,
