...
async function sendWelcomeEmailForUser(userId, role) {
...
const sendWelcomeEmail_createServerFn_handler = createServerRpc({
  id: "abe666add245791c4809f545ca350c25ee01dec56db9c0f6797c6a530a4e96b3",
  name: "sendWelcomeEmail",
  filename: "src/lib/profile.functions.ts"
}, (opts) => sendWelcomeEmail.__executeServer(opts));
const sendWelcomeEmail = createServerFn({
  method: "POST"
}).middleware([requireSupabaseAuth]).handler(sendWelcomeEmail_createServerFn_handler, async ({
  context
}) => {
  const {
    supabase,
